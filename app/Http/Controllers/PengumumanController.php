...
class PengumumanController extends Controller
{
    ...
    public function adminIndex(Request $request)
    {
        ...
        // If there's a search term in the request, filter by 'judul'
        ...
        $allPengumuman = $query->whereNull('deleted_at')->get();

        // Format the date for each pengumuman
    ...
    public function destroy($id)
    {
        try {
            ...
            $pengumuman->delete(); // Soft delete the pengumuman
