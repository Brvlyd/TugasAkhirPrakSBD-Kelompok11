        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.layanan.index')" :active="request()->routeIs('admin.layanan.index')">
                        {{ __('Layanan') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.galeri.index')" :active="request()->routeIs('admin.galeri.index')">
                        {{ __('Galeri') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.navbar.index')" :active="request()->routeIs('admin.navbar.index')">
                        {{ __('Navbar') }}
                    </x-nav-link>
