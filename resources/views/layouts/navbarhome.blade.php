...
<body>
    <nav x-data="{ scrolled: false, showNav: true, lastScrollY: 0, timeout: null }" x-init="window.addEventListener('scroll', () => {
         ...
         })" :class="{'bg-yellow-500': true, 'transform -translate-y-full': !showNav, 'transform translate-y-0': showNav}" class="fixed w-full h-20 z-50 py-2 transition-transform duration-500 ease-in-out">
        <div class="container mx-auto flex justify-between items-center flex-wrap">
            <a href="{{ route('home') }}">
                <div class="text-black font-bold flex items-center mt-1 ms-12 mt-6">
